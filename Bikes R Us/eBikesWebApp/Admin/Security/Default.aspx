<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="eBikesWebApp.Admin.Security.Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-md-9">
            <h2>
                Users
                <a href="~/Admin/Security/RegistereBikesUsers.aspx" runat="server" class="btn btn-default">eBikes User Registrations &rarr;</a>
            </h2>
            <asp:ListView ID="UsersListView" runat="server"
                ...
                ItemType="eBikesWebApp.Admin.Security.DTOs.RegisteredUser">
                <EditItemTemplate>
                    <tr style="">
                ...
                ItemType="eBikesWebApp.Admin.Security.DTOs.RegisteredUser.UserRole">
    ...
    <asp:ObjectDataSource ID="UsersDataSource" runat="server"
        DataObjectTypeName="eBikesWebApp.Admin.Security.DTOs.RegisteredUser"
        DeleteMethod="DeleteUser"
        InsertMethod="AddUser"
        OldValuesParameterFormatString="original_{0}"
        SelectMethod="ListUser"
        TypeName="eBikesWebApp.Admin.Security.SecurityController"
