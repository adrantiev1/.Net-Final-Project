<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegistereBikesUsers.aspx.cs" Inherits="eBikesWebApp.Admin.Security.RegistereBikesUsers" %>

<%@ Register Src="~/UserControls/MessageUserControl.ascx" TagPrefix="uc1" TagName="MessageUserControl" %>


<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h1>Process Unregistered Employees</h1>
        ...
        <ItemTemplate>
            <tr style="">
                ...
                <td>
                    ...
                    <asp:Label Text='<%# Eval("Position") %>' runat="server" ID="UserTypeLabel" />
                </td>
                <td>
    ...
    <asp:ObjectDataSource ID="UnregisteredUsersDataSource" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="ListAllUnregisteredUsers" TypeName="eBikesWebApp.Admin.Security.RegistrationController"></asp:ObjectDataSource>
</asp:Content>
